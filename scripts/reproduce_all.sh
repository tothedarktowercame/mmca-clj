...
for s in plot_fig1 plot_fig3 plot_fig4 plot_fig5 plot_fig6 plot_fig8 plot_figshell \
         plot_two4cycle plot_eoc_tint plot_eoc_interface plot_eoc_phase; do
  python3 "scripts/$s.py"
done

echo "reproduced 12 draft4 figures into figures/:"
echo "  rule110_spread fig8 parity-dichotomy survey_a survey_b lambda_analogue"
echo "  river critical_shell two4cycle eoc_tint eoc_interface eoc_phase"
