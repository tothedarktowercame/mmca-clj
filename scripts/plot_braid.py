"""Braiding two operators that each collapse alone. Complementary block systems
(offset+2 x offset+4) revive; the same evens/odds partition (offset+2 x offset-2)
stays dead. Reads data/braid_*.txt; writes figures/braid.png."""
...
fig.suptitle("Braiding two operators that each collapse alone: complementary block systems revive,\n"
             "the same partition stays dead", fontsize=11, y=0.965)
